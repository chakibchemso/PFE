    ...
    I2C: i2c::I2c<Error = E>,
{
    ...
    pub async fn set_pulse_amplitude(&mut self, led: Led, amplitude: u8) -> Result<(), Error<E>> {
        match led {
            Led::Led1 => self.write_data(&[Reg::LED1_PA, amplitude]).await,
            Led::Led2 => self.write_data(&[Reg::LED2_PA, amplitude]).await,
            Led::All => self.write_data(&[Reg::LED1_PA, amplitude, amplitude]).await,
        }
    }
}
    ...
    I2C: i2c::I2c<Error = E>,
{
    ...
    pub async fn set_led_time_slots(&mut self, slots: [TimeSlot; 4]) -> Result<(), Error<E>> {
